...
export default function EditarProdutos(){
      ...
      // Podemos passar na lista de monitoramento, os objetos que
      // queremos monitorar, mas se deixarmos essa lista vazia,
      // o useEffect vai monitorar o próprio componente em que ele está 
      useEffect(() => 
      {
  ...
  useEffect(() => 
      {
          console.log("o Id foi atualizado: ", contador)
      }, [contador])
